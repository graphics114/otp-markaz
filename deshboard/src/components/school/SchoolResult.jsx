                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 text-white relative overflow-hidden shadow-2xl">
                    ...
                    <div className="relative z-10 md:flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-400 mt-2 max-w-md">Access detailed analytics and individual student reports for all courses in Academic.</p>
                        </div>
