...
import ResetPassword from "../pages/resetUserPassword";
import { toggleRegisterUser, toggleResetPassword, toggleUpdateUser } from "../store/slices/extraSlice";
...
const Users = () => {
    ...
    const { isRegisterUserOpened, isUpdateUserOpened, isResetPasswordOpened } = 
    ...
    // EXCEL EXPORT
    const handleExcel = () => {
      // Staff + Student മാത്രം, search filter apply ചെയ്യുന്നു
    ...
    <main className="p-[10px] pl-[10px] md:pl-[17rem] w-full">
        ...
        <div className="p-4 sm:p-8 bg-gray-50 min-h-full">
            ...
            {/* USER TABLE */}
            <div id="users-table-print" className={`overflow-x-auto rounded-lg ${
                        ...
                        <table className="min-w-full bg-white border border-gray-200">
                            <thead className="bg-blue-100 text-gray-700">
                                <tr>
                                    ...
                                    <th className="py-3 px-4 text-left actions-col">Reset</th>
                                    <th className="py-3 px-4 text-left actions-col">Delete</th>
                                </tr>
                            </thead>
                            <tbody>
                                {users.filter((user) => (user.role === "Staff" || user.role === "Student") && 
                                    (
                                    ...
                                    return(
                                        <tr key={index} className="border-t hover:bg-gray-50">
                                            ...
                                            <td className="actions-col">
                                                ...
                                                className="text-yellow-500 cursor-pointer py-3 px-3
                                                font-semibold">
                                                    <KeyRound className="w-6 h-auto" />
                                                </button>
                                            </td>
                                            <td className="actions-col">
                                                {/* DELETE USER */}
    ...
    {isResetPasswordOpened && <ResetPassword selectedUser={selectedUser} />}
    </>);
};
