    ...
    <div className="relative w-full bg-gray-50 min-h-screen">
      <div className="p-[10px] pl-[10px] md:pl-[17rem] w-full">
        ...
        <div className="flex-1 p-6">
          ...
          <button onClick={() => dispatch(toggleHifizCollage())}
            className="gap-1 text-sm font-medium text-blue-600
                          ...
                          <td className="py-3 px-4 actions-col">
                            <span
                              ...
                              <select
                                ...
                                onChange={(e) =>
                                  handleResultChange(result.result_id, "result_status", e.target.value)
                                }
